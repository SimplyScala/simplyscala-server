...
* Stub Server Fixture Trait                                                            TODO
...
You must not stop the server thanks to when a define port is already used, simplyscala-server start server with next port.
