...
* inject fonction like Request => ServerResponse                                       TODO
...
http://search.maven.org/remotecontent?filepath=com/github/simplyscala/simplyscala-server_2.9.2/0.2/simplyscala-server_2.9.2-0.2.jar
