...
with fr.simplyscala.util._ import you can use some utilities to declare server's content type
...
You can use i like that with "ScalaTest":http://www.scalatest.org/ :
